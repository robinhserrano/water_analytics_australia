        ...
        actions: [
          IconButton(
            onPressed: () {
              ...
              //  context.read<MemberDetailCubit>().fec
              //modify this 07/12
            },
            icon: const HeroIcon(
              HeroIcons.arrowPath,
...
// class MemberDetailPageWrapperProvider extends StatelessWidget {
//   const MemberDetailPageWrapperProvider({
//     required this.rep,
//     super.key,
//   });
...
//       body: RefreshIndicator(
//         color: const Color(0xff0083ff),
//         onRefresh: () => context.read<MemberDetailCubit>().fetchSalesByReps(),
//         child: Padding(
//           padding: const EdgeInsets.symmetric(horizontal: 4),
//           child: BlocBuilder<MemberDetailCubit, MemberDetailCubitState>(
//             builder: (context, state) {
...
//                 return MemberDetailError(
//                   onRefresh: () =>
//                       context.read<MemberDetailCubit>().fetchSalesByReps(),
//                 );
//               }
//               return const SizedBox();
//             },
...
// class MemberDetailLoaded extends StatefulWidget {
//   const MemberDetailLoaded({required this.records, super.key});
