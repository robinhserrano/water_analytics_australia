...
class CloudCustomDataTable extends StatefulWidget {
  const CloudCustomDataTable({
    required this.data,
    required this.total,
  ...
  final List<CloudOrderLines> data;
  final int total;
  final bool sortDescending;
  final int? sortColumnIndex;
  @override
  State<CloudCustomDataTable> createState() => _CloudCustomDataTableState();
}

class _CloudCustomDataTableState extends State<CloudCustomDataTable> {
...
class CloudCustomDataTableLoading extends StatelessWidget {
  const CloudCustomDataTableLoading({super.key});
