...
class AwsCustomDataTable extends StatefulWidget {
  const AwsCustomDataTable({
    required this.data,
    required this.total,
  ...
  final List<AwsOrderLine> data;
  final int total;
  final bool sortDescending;
  final int? sortColumnIndex;
  @override
  State<AwsCustomDataTable> createState() => _AwsCustomDataTableState();
}

class _AwsCustomDataTableState extends State<AwsCustomDataTable> {
...
class AwsCustomDataTableLoading extends StatelessWidget {
  const AwsCustomDataTableLoading({super.key});
